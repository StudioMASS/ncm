	...
	<div class="container">
		...
		<div class="rhs">
			<div class="top">
				{#if success}
					<p class="medium">
						Thanks for subscribing to our weekly newsletter. Expect to recieve project updates,
						insights into our collection, and invites to events & initiatives.
					</p>
				...
				{:else}
					<p class="medium">
						Join our weekly newsletter to get project updates, insights into our collection, and
						invites to events & initiatives.
					</p>
					{#if error}
